...
1. Wire per the pin map in [`docs/PREHEND_HANDOFF.md`](docs/PREHEND_HANDOFF.md) §4. Set `auxMode`
...
See [`docs/PREHEND_HANDOFF.md`](docs/PREHEND_HANDOFF.md) for the full spec, references, and build order.
